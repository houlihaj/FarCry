...
private:
    ...
    CImageList  m_disabledImages; // disabled images of the added buttons, created only when CreateDisabledImageList() is called.
...
public:
	...
	// Summary:	Creates and enables the disabled image list
