...
protected:
	...
	// Summary:	This member function will return the total width of all the tabs
	//			in the flat tab control. 
	int GetTotalTabWidth() const;

	// Returns: The total width in pixels of all the visible arrow buttons.
	// Summary:	This member function will return the total width of all the arrow
	...
	// Summary:	This member function will return the total area width of all the
