...
protected:
	...
	//			lptvitem - Pointer to a tree view item that is about to be added to the tree.
...
public:
	...
	// Returns: true if successful, otherwise returns false.
    // Summary:	This member function executes the item clicked on
	...
	virtual void ShellListUpdate();
	virtual void ShellListRestart();
