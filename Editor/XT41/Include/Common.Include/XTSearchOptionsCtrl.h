...
public:
	...
	// Returns: An integer value that represents the distance the controls will be moved.
...
protected:
	...
	//			for group boxes.[/li]
	//			[/ul]
    // Summary:	Constructs a CXTSearchOptionsView object, the same as if you were constructing
