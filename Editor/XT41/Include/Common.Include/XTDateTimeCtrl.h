...
public:
	...
	//			calendar within a date and time picker control.
	...
	// Input:	pTimeNew - A pointer to a CTime object containing the time that 
    //			the control will be set to.
	// Returns: Nonzero if successful, otherwise returns zero. 
    // Summary:	This member function sets the time in a date and time picker control.
    BOOL SetTime(const CTime* pTimeNew);

	// Input:	timeNew - A reference to a COleDateTime object containing the time that 
    //			the control will be set to.
	// Returns: Nonzero if successful, otherwise returns zero.
    // Summary:	This member function sets the time in a date and time picker control.
    ...
    //			the time that the control will be set to.
	// Returns: Nonzero if successful, otherwise returns zero. 
    // Summary:	This member function sets the time in a date and time picker control.
...
//			provides the user with a simple calendar interface that the user
...
public:
	...
	// Returns: An integer that represents the range, in months, spanned by the two
	//			limits indicated by 'refMinRange' and 'refMaxRange'.
    // Summary:	This member function retrieves date information that represents the
	//			high and low limits of a month calendar control's display. 
