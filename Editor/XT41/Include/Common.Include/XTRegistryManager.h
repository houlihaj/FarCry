...
public:
	...
	// Returns: Zero if the section is empty; otherwise it returns the number of values
	//			present.
	...
	//			or ANSI string, depending on whether or not you use the Unicode or
	//			ANSI functions.[/li]
	//			[/ul]
	//			The function also takes a pointer to a CStringArray because CMap is
	//			a sorted container; therefore, it is not possible to get the items
	...
	// Summary:	Call this function to delete a registry key and all of its contents.
