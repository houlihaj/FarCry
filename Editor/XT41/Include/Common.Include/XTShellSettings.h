...
public:
	...
	// Summary:	This member function checks whether or not the Show All Files option is
	//			enabled. 
	bool ShowAllFiles();

	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Hide File Extensions for
	...
	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Do Not Show Hidden Files
	//			option is selected. 
	bool ShowSysFiles();
	
	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Display Compressed Files
	//			and Folders with Alternate Color option is enabled. 
	bool ShowCompColor();
	
	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Double-Click to Open an
	//			Item option is enabled. 
	bool DoubleClickOpen();

	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Active Desktop – View as
	//			Web Page option is enabled. 
	bool HTMLDesktop();
	
	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Classic Style option is
	//			enabled. 
	bool Win95Classic();

	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Allow All Uppercase Names
	//			option is enabled. 
	bool AllowUpperCase();

	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Show File Attributes in
	//			Detail View option is enabled. 
	bool ShowAttributes();

	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Show Map Network Drive
	//			Button in Toolbar option is enabled. 
	bool ShowMapNetworkDrive();
	
	// Returns: true if enabled, otherwise returns false.
	// Summary:	This member function checks whether or not the Show Info Tips for Items
