...
#else
typedef CMap<HTREEITEM,HTREEITEM,XT_CLRFONT,XT_CLRFONT&> CXTColorFontMap;
#endif
...
public:
	...
	//			root item that the specified item is a part of.[/li]
    //			[/ul]
    ...
    // Summary:	This member function searches the entire tree for an item label that contains the search string.
	...
	//			the currently selected tree item.
	// Returns: The handle to the item, or returns NULL.
    // Summary:	This member function searches the entire branch specified by htiItem for an item label 
    ...
    // Summary:	This member function checks whether or not the tree item has a bold font.
	...
	//			NULL, this function selects no item.  
	...
	// Summary:	This member function checks whether or not the specified item is selected.
	...
	// Summary:	This member function checks whether or not the tree control is a multi-select
	//			tree. 
	BOOL IsMultiSelect() const;

	// Input:	bLabel - TRUE to select items only when banding rect passes over the text label;
	//			FALSE to select items when banding rect passes over any part of
	//			the tree item.
	// Returns: The previous banding state.
	// Summary:	This member function sets the banding mode for a multi-selection tree
	//			control. If 'bLabel' is TRUE, items are selected only when the
	//			banding rect passes over the tree item label. If 'bLabel' is FALSE,
	//			passing over any part of the tree item will cause selection to
