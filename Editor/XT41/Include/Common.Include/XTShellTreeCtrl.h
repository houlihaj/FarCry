...
protected:
	...
	//			lpifq - Fully qualified item ID list to the item that is having items enumerated.
    ...
    // Summary:	This member function retrieves the index for the normal and selected
