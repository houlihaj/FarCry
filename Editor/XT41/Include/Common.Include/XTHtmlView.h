...
public:
	...
	// Summary:	Call this member function to determine whether or not the menu bar is visible.
	//			Applies to Internet Explorer and WebBrowser.  
	...
	// Summary:	Call this member function to get the value of the property that is currently
