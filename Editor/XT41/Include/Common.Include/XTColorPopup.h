...
public:
	...
	// Input:	clrColor - An RGB value that represents the user defined color to be displayed in
	...
	// Summary: This member function adds a window that picker notifications are sent to.
	...
	//			object's initialization.  Do <b>not</b> call it after popup creation because 
