...
protected:
	...
	// virtual int OnToolHitTest(CPoint point, TOOLINFO* pTI) const;  // as found
	virtual INT_PTR OnToolHitTest(CPoint point, TOOLINFO* pTI) const;  // John Houlihan
	...
	// afx_msg UINT OnNcHitTest(CPoint point);  // as found
	afx_msg LRESULT OnNcHitTest(CPoint point);  // John Houlihan
